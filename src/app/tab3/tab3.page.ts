...
export class Tab3Page implements OnInit {
  ...
  awardObject = [
    ...
    { id: 'DES2', points: 20, goal: false, title: '每日情緒、睡眠一周紀錄5天' },
    ...
    { id: 'EMO2', points: 20, goal: false, title: '達成一周紀錄5天' },
    { id: 'EMO3', points: 30, goal: false, title: '達成一個月紀錄20天' },
    { id: 'EMO4', points: 50, goal: false, title: '達成一個月紀錄28天' },
    { id: 'EMO5', points: 70, goal: false, title: '達成三個月紀錄55天' },
    { id: 'EMO6', points: 100, goal: false, title: '達成三個月紀錄80天' },

    { id: 'SCL1', points: 10, goal: false, title: '達成填寫1次每周的量表' },
    { id: 'SCL2', points: 15, goal: false, title: '達成一個月填寫每周的量表3次' },
    { id: 'SCL3', points: 25, goal: false, title: '達成兩個月填寫每周的量表10次' },
    { id: 'SCL4', points: 30, goal: false, title: '達成三個月填寫每周的量表12次' },

    { id: 'GES1', points: 20, goal: false, title: '達成一周GPS、每日記錄、隨時紀錄皆有5天。' },
